...
async def _(event):
   if not event.is_group:
    ...
    await event.reply("**Click me for help!**", buttons=[[Button.url("Click me for help","t.me/Seona_Robot?start=help")]],"**Support**", buttons=[[Button.url("Support","t.me/DevsChatroom")]])
